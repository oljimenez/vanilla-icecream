...
> Downside of this function is that this will add a tiny runtime because have to iterate over given props of your component.
> I recommend use [rainbow-sprinkles](https://github.com/wayfair/rainbow-sprinkles) that give you the same and more with zero runtime.
